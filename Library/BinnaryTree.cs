...
namespace Library
{
    public class BinnaryTree : ITree
    {
        ...
        {
            var node = GetNodeByValue(8);
            PrintBranch(_root, WindowWidth / 2, CursorTop, GetHeight());
        }
        ...
        private void PrintBranch(TreeNode node, int x, int y, int height, int level = 0)
        {
            ...
            if (node.LeftChild != null)
            {
                ...
                PrintBranch(node.LeftChild, branchX, y, height, level);
                level--;
            }
            ...
            if (node.RightChild != null)
            {
                ...
                PrintBranch(node.RightChild, branchX, y, height, level);
                level--;
            }
        }
    }
